...
import type { EmailVariables, AllEmailVariables } from "@/lib/types/prospector-analysis";
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-sm font-medium text-green-800">
                Email variables sent to Apollo successfully!
              </p>
              {selectedAccount && (
                <p className="text-sm text-green-700 mt-1">
                  Updated: {selectedAccount.name}
                </p>
              )}
            </div>
          </div>
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-text-secondary mb-4">
          Search for a company in Apollo and update their custom fields with the email variables.
        </p>
      </div>
        ...
        <div className="flex items-center justify-between p-3 bg-primary/5 border border-primary/20 rounded-lg">
          <div>
            ...
            <div className="text-xs text-text-secondary">
              Will update 8 custom fields on this account
            </div>
          </div>
          <button
            onClick={handleSend}
